...
/**
 * Description of second_sample_structure
 *
 */
typedef struct {
    int sample_integer;  /*!< Description of sample_integer */
    void (*sample_function_a)(int sample_integer); //! Description of sample_function_a
    void (*sample_function_b)(int sample_integer); //! Description of sample_function_b
} another_sample_structure;
